...
export const InputWorkbench: React.FC<InputWorkbenchProps> = ({
  ...
  return (
    <div className="rounded-3xl border border-slate-200/90 dark:border-zinc-800/90 bg-white dark:bg-zinc-900 p-4 sm:p-6 md:p-8 shadow-xs space-y-4 sm:space-y-6 transition-colors">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {batchMode && (
              <span className="px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-indigo-50 dark:bg-indigo-950/70 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800">
                Batch Mode Active
              </span>
            )}
          </div>
        ...
        {/* Real-time stats */}
        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-mono text-slate-500 dark:text-zinc-400">
          <span className="px-2.5 py-1 rounded-xl bg-slate-100 dark:bg-zinc-800/90 font-medium">
          ...
          <span className="px-2.5 py-1 rounded-xl bg-slate-100 dark:bg-zinc-800/90 font-medium">
            {stats.chars} chars ({stats.charsNoSpaces} no spaces)
          </span>
          <span className="px-2.5 py-1 rounded-xl bg-slate-100 dark:bg-zinc-800/90 font-medium">
      ...
      <div className="relative">
        <textarea
          ...
          className="w-full p-4 sm:p-5 rounded-2xl bg-slate-50/80 dark:bg-zinc-950/80 border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-zinc-100 placeholder-slate-400 dark:placeholder-zinc-600 font-mono text-xs sm:text-sm leading-relaxed focus:outline-hidden focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all resize-y min-h-[140px]"
        />
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 pt-1">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className={`px-3 sm:px-4 py-2 rounded-xl text-xs font-semibold flex items-center gap-2 border transition-all cursor-pointer ${
              batchMode
          ...
          <div className="relative group">
            <button
              type="button"
              className="px-3 sm:px-4 py-2 rounded-xl text-xs font-medium border border-slate-200 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-800/60 text-slate-700 dark:text-zinc-300 hover:bg-slate-100 dark:hover:bg-zinc-800 flex items-center gap-1.5 sm:gap-2 transition-colors cursor-pointer"
            >
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
          {previousInput !== null && onRestorePrevious && (
            <button
              ...
              className="px-3 sm:px-3.5 py-2 rounded-xl text-xs font-medium border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-slate-600 dark:text-zinc-400 hover:bg-slate-50 dark:hover:bg-zinc-800 flex items-center gap-1.5 transition-colors cursor-pointer"
          ...
          <button
            type="button"
            onClick={handlePaste}
            className="px-3 sm:px-3.5 py-2 rounded-xl text-xs font-medium border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-slate-700 dark:text-zinc-300 hover:bg-slate-50 dark:hover:bg-zinc-800 flex items-center gap-1.5 transition-colors cursor-pointer shadow-2xs"
          ...
          <button
            ...
            disabled={!input}
            className="px-3 sm:px-3.5 py-2 rounded-xl text-xs font-medium text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 border border-transparent hover:border-rose-200 dark:hover:border-rose-900/60 flex items-center gap-1.5 transition-colors disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
            title="Clear text"
          >
